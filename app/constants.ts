...
export const WebsiteProjects: ProjectProps[] = [
  {
    ...
    body: 'Thirty Factor Authentication. Verify yourself by completing thirty different authentication challenges. Each challenge increasingly more bizarre than the last. ',
